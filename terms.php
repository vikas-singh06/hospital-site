        ...
        <div class="row p-5 d-flex align-items-center justify-content-center">
            ...
            <div class="links ml-auto ml-sm-0 ml-md-0 w-auto">
                <a href="./index.php">Home</a><i class="fa-solid fa-arrow-left-long fa-flip-horizontal"></i><a
                    href="./terms.php">Terms & Condition</a>
            </div>
        </div>
    </div>
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col">
                ...
                <h2>Welcome to VIK HEALTH CARE!</h2>

                <p>These terms and conditions outline the rules and regulations for the use of VIK CARE's Website,
                    located at www.vikhealthcare.com.</p>

                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use VIK
                    HEALTH CARE if you do not agree to take all of the terms and conditions stated on this page.</p>
                ...
                <p>We employ the use of cookies. By accessing VIK HEALTH CARE, you agreed to use cookies in agreement
                    with the VIK CARE's Privacy Policy. </p>
                ...
                <p>Unless otherwise stated, VIK CARE and/or its licensors own the intellectual property rights for all
                    material on VIK HEALTH CARE. All intellectual property rights are reserved. You may access this from
                    VIK HEALTH CARE for your own personal use subjected to restrictions set in these terms and
                    conditions.</p>

                <p>You must not:</p>
                <ul>
                    <li>Republish material from VIK HEALTH CARE</li>
                    <li>Sell, rent or sub-license material from VIK HEALTH CARE</li>
                    <li>Reproduce, duplicate or copy material from VIK HEALTH CARE</li>
                    <li>Redistribute content from VIK HEALTH CARE</li>
                </ul>


                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. VIK CARE does not filter, edit, publish or review Comments prior to
                    their presence on the website. Comments do not reflect the views and opinions of VIK CARE,its agents
                    and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                    opinions. To the extent permitted by applicable laws, VIK CARE shall not be liable for the Comments
                ...
                <p>VIK CARE reserves the right to monitor all Comments and to remove any Comments which can be
                ...
                <p>You hereby grant VIK CARE a non-exclusive license to use, reproduce, edit and authorize others to
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                    ...
                    the absence of VIK CARE; and (d) the link is in the context of general resource information.</p>
